...
export const Section = ({ title, description, children }: { title: string, description: React.ReactNode, children: React.ReactNode }) => {
  return (
    <section className="flex flex-col gap-4 h-screen w-full space-y-4 justify-center items-center text-center align-center max-w-md px-8 md:max-w-3xl mx-auto py-12">
